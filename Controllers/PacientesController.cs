...
namespace VirtualHosp.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HistorialMedico,Medicamentos,AntecedentesMedicos,PlanMedico,Id,Nombre,Apellido,FechaNacimiento,TipoDocumento,NumeroDocumento,EstadoCivil,Email,Direccion,Nacionalidad,Ciudad,CodigoPostal,Password")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HistorialMedico,Medicamentos,AntecedentesMedicos,PlanMedico,Id,Nombre,Apellido,FechaNacimiento,TipoDocumento,NumeroDocumento,EstadoCivil,Email,Direccion,Nacionalidad,Ciudad,CodigoPostal,Password")] Paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
