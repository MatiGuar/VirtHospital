...
namespace VirtualHosp.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HorarioInicio,HorarioFinal")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HorarioInicio,HorarioFinal")] Consulta consulta)
        {
            if (id != consulta.Id)
            {
                return NotFound();
